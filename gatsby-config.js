...
module.exports = {
  ...
  siteMetadata: {
    ...
    description: `The best digital school in Kosovo`,
    author: `Starlabs`,
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        custom: {
          families: ["Australia", "cocacola", "ylbi"],
          urls: ["/static/fonts.scss"],
        },
      },
    },
    ...
    //     uploadsUrl: 'http://localhost/digital-school/wp-content/uploads/',
    ...
    
    {
      ...
      options: {
         ...
         */
        baseUrl: "dev.shkolladigjitale.com/wordpress",
